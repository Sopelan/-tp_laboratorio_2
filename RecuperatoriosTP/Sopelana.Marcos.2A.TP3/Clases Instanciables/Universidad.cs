...
namespace Clases_Instanciables
{
    public class Universidad 
    {
        ...
        { 
            ...
            return  guardar.Guardar(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) +@"\xml.xml", uni);
        }
        public static Universidad Leer()
        {
            Xml<Universidad> leer = new Xml<Universidad>();
            leer.Leer(Environment.GetFolderPath(Environment.SpecialFolder.Desktop)+ @"\xml.xml", out Universidad universidad);
            return universidad;
        }
